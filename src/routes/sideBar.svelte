    ...
    {#each $figuresData as figure,i}
        <Card>
            {#if (figure.figureType == FigureType.Circle) }
                <CircleComponent i={i} figure={figure} remove_figure={remove_figure} reset={stateStore.resetState}/>
            {/if}
            {#if (figure.figureType == FigureType.Square) }
                <NgonComponent i={i} figure={figure} remove_figure={remove_figure} reset={stateStore.resetState}/>
            {/if}
        </Card>
    {/each}
    <Card>
